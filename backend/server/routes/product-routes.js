...
// find token in a page 

router.get('/search/:token', product_controller.findToken);

router.post(
    '/', [v.name_prod, v.desc_short, v.desc_long, v.price, v.stock, v.category],
    product_controller.insertProduct
);

router.get(
    '/category/:id', [v.param_id],
    product_controller.getProductsCategory
);

router.get('/last', product_controller.getLast);
